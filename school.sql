...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 13, 2023 at 02:37 AM
...
CREATE TABLE `admin` (
  ...
  `clgid` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `semester` int(11) NOT NULL,
  `username` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `pass` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `role` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `Enrollment` varchar(200) COLLATE utf8_unicode_ci NOT NULL
...
(10, 'mk', '0', 0, '5', '5', 'Student', 'Enrollment');
...
INSERT INTO `assingment` (`id`, `tg`, `studentName`, `subject`, `assingment`, `date`) VALUES
(5, 'om', 'Mk', '', 'C++,hindi', '2023-03-10');
...
(1, 'Mk', '150410', '4', '52', 'SLF-Logo (1).png', 'remark', 'date');
