...
$assingment=implode(',',$_POST['assingment']);
 ...
 $date=date('Y-m-d');
    ...
    $QuerygetData="INSERT INTO `tutorial`(`tg`, `studentName`,  `assingment`, `date`) VALUES ('$Usernamename', '$studentname',  '$assingment', '$date')";
                ...
                <div class="content-wrapper">
                    ...
                    <section class="content-header">
                        ...
                        <div class="header-title">
                            ...
                            <h1>Student  </h1>
                            <small>Student Tutorial  Details</small>&nbsp;&nbsp; <b ></b>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    ...
                                    <?php echo @$msg;?> 
                                        <div class="btn-group"> 
                                          <h3>Student Tutorial  Details</h3>
                    ...
                    { while ($row=mysqli_fetch_assoc($result)) {
                           ?>
						      <tr>
                               ...
                               <td><a href="Recorddelete.php?table=tutorial&id=<?php echo $row['id']?>&url=tourial"> <span class="fa fa-trash fa-2x text-danger"> </span></a></td>       
